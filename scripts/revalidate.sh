...
if [[ -d crates/audiacore-time ]]; then
  ...
  ! grep -q 'impl Default for TimerSet' "$time_src" || fail "time regained unproven implicit empty construction"
